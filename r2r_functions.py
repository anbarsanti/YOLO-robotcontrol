...
def track_from_webcam(model, OBB=True, print_to_csv=False):
    '''
            ...
            for r in results:
                ...
                if OBB == True:
                    ...
                    for i in range(len_cls):
                        ...
                        cxyxyxyxyn_1 = [*[(cls[(i + 1) % len_cls].tolist())],
                                        *(xyxyxyxyn_flatten_1)]  # Append class with its OBB
                        # print(cxyxyxyxyn)
                        
                        # Calculating the Area of Intersection
                        # intersection_area_OBB_diy(cxyxyxyxyn, cxyxyxyxyn_1)
                        print("Area of Intersection between class", cls[i].item(), "and class",
                              cls[(i + 1) % len_cls].item(), "is", intersection_area_OBB_diy(cxyxyxyxyn, cxyxyxyxyn_1))
                    ...
                    for i in range(len_cls):
                        ...
                        print("Area of Intersection between class", cls[i].item(), "and class",
                              cls[(i + 1) % len_cls].item(), "is", intersection_area_HBB(cxyxyn, cxyxyn_1))
...
def track_from_intelrealsense(model, OBB=True, print_to_csv=False):
    '''
        ...
        for r in results:
            ...
            if OBB=True:
                ...
                for i in range(len_cls):
                    xyxyxyxyn_flatten = (np.array((xyxyxyxyn[i].tolist())).reshape(1, 8).tolist())[
                        0]  # Flatten the xyxyxyxy
                    xyxyxyxyn_flatten_1 = (np.array((xyxyxyxyn[(i + 1) % len_cls].tolist())).reshape(1, 8).tolist())[
                        0]  # Flatten the xyxyxyxy_1
                    cxyxyxyxyn = [*[(cls[i].tolist())], *(xyxyxyxyn_flatten)]  # Append class with its OBB
                    cxyxyxyxyn_1 = [*[(cls[(i + 1) % len_cls].tolist())],
                                    *(xyxyxyxyn_flatten_1)]  # Append class with its OBB
                    ...
                    # intersection_area_OBB_diy(cxyxyxyxyn, cxyxyxyxyn_1)
                    print("Area of Intersection between class", cls[i].item(), "and class",
                          cls[(i + 1) % len_cls].item(), "is", intersection_area_OBB_shapely(cxyxyxyxyn, cxyxyxyxyn_1))
